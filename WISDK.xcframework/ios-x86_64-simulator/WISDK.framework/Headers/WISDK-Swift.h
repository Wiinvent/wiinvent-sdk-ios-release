...
typedef SWIFT_ENUM(NSInteger, WI3rdBannerAdSize, open) {
  WI3rdBannerAdSizeHOMEPAGE_BANNER = 0,
  WI3rdBannerAdSizeSUBPAGE_BANNER = 1,
  WI3rdBannerAdSizePAUSE_BANNER = 2,
};

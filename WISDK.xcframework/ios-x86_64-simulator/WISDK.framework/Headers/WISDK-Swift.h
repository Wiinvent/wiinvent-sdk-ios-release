...
typedef SWIFT_ENUM(NSInteger, WI3rdBannerAdBannerType, open) {
  WI3rdBannerAdBannerTypeDisplay = 0,
  WI3rdBannerAdBannerTypeOverlay = 1,
};
...
- (void)wi3rdBannerAdManager:(WI3rdBannerAdManager * _Nonnull)manager hasNoAdAt:(UIView * _Nullable)containerView;
- (void)wi3rdBannerAdManager:(WI3rdBannerAdManager * _Nonnull)manager skipAdAt:(UIView * _Nullable)containerView;
- (BOOL)wi3rdBannerAdManager:(WI3rdBannerAdManager * _Nonnull)manager pauseBannerVisibleAt:(UIView * _Nullable)containerView SWIFT_WARN_UNUSED_RESULT;
@end
...
typedef SWIFT_ENUM(NSInteger, WI3rdBannerAdSize, open) {
  ...
  WI3rdBannerAdSizeMINI_BANNER = 3,
  WI3rdBannerAdSizeMEDIUM_BANNER = 4,
  WI3rdBannerAdSizePAUSE_BANNER = 5,
};


SWIFT_CLASS("_TtC5WISDK26WI3rdBannerReusableManager")
@interface WI3rdBannerReusableManager : NSObject
...
- (nonnull instancetype)initWithAccountId:(NSString * _Nullable)accountId transId:(NSString * _Nullable)transId age:(NSInteger)age gender:(enum WIGender)gender uid20:(NSString * _Nonnull)uid20 env:(enum WIEnvironment)env segments:(NSString * _Nonnull)segments OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithAccountId:(NSString * _Nullable)accountId transId:(NSString * _Nullable)transId age:(NSInteger)age gender:(enum WIGender)gender uid20:(NSString * _Nonnull)uid20 domainUrl:(NSString * _Nullable)domainUrl env:(enum WIEnvironment)env segments:(NSString * _Nonnull)segments OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
